...
class Linguagem(models.Model):
    lingua = models.CharField('Linguagem',max_length=30, default="Português-Br")
    
    def __str__(self):
        return self.lingua

class Jornal(models.Model):
    nome = models.CharField('Nome do Jornal', max_length=50)
...
class Tema(models.Model):
    tema=models.CharField("Tema",max_length=60)
    def __str__(self):
        return self.tema
...
class Tipo_midia(models.Model):
    tipo = models.CharField('Título',max_length=300,help_text="Nome da produção")
...
class Producao(models.Model):
    titulo=models.CharField('Título',max_length=300,help_text="Nome da produção")
